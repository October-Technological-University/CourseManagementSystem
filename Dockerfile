...
# By specifying the "8.5.5-apache" tag, it will also use whatever happens to be the
# most recent version of that tag when you build your Dockerfile.
# If reproducibility is important, consider using a specific digest SHA, like
# php@sha256:99cede493dfd88720b610eb8077c8688d3cca50003d76d1d539b0efc8cca72b4.
FROM php:8.5.5-apache as final
...
# COPY ./PL/public /var/www/html

# Copy the app dependencies from the previous install stage.
COPY --from=deps app/vendor/ /var/www/vendor
COPY ./PL /var/www/html
# Copy all required layers to /var/www/ to match relative paths
